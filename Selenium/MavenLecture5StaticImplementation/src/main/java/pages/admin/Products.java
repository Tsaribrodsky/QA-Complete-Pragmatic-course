...
public class Products {
    ...
    private static final By LOC_BUTTON_CATALOG = By.xpath("//a[text()=' Catalog']");
    private static final By LOC_LINK_PRODUCTS = By.xpath("//li[@id='menu-catalog']//a[text()='Products']");
    private static final By LOC_BUTTON_ADD_NEW_PRODUCT = By.cssSelector("i.fa-plus");
    private static final By LOC_PRODUCT_NAME = By.cssSelector("input#input-name1");
    private static final By LOC_META_TAG_TITLE = By.cssSelector("input#input-meta-title1");
    private static final By LOC_BUTTON_DATA = By.xpath("//li/a[text()='Data']");
    private static final By LOC_MODEL = By.cssSelector("input#input-model");
    private static final By LOC_SAVE_BUTTON = By.cssSelector("i.fa-save");
    private static final By LOC_SUCCESS_ADD_PRODUCT_MESSAGE = By.cssSelector("div.alert-success");
    private static final By LOC_FILTER_PRODUCT_NAME = By.cssSelector("input#input-name");
    private static final By LOC_BUTTON_FILTER = By.cssSelector("button#button-filter");
    private static final By LOC_CHECKBOX_AFTER_FILTER_PRODUCT = By.xpath("//tbody//input[@type='checkbox']");
    private static final By LOC_BUTTON_DELETE_CHECKED_PRODUCT = By.cssSelector("i.fa-trash-o");
